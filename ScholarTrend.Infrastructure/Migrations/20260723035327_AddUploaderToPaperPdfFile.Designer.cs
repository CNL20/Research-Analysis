...
namespace ScholarTrend.Infrastructure.Migrations
{
    ...
    [Migration("20260723035327_AddUploaderToPaperPdfFile")]
    partial class AddUploaderToPaperPdfFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScholarTrend.Domain.Entities.PaperAnalysis", b =>
                {
                    b.HasOne("ScholarTrend.Domain.Entities.ResearchPaper", "Paper")
                        .WithOne("Analysis")
                        .HasForeignKey("ScholarTrend.Domain.Entities.PaperAnalysis", "PaperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ScholarTrend.Domain.Entities.PaperPdfFile", b =>
                {
                    ...
                    b.HasOne("ScholarTrend.Domain.Entities.User", "UploadedBy")
                        .WithMany()
